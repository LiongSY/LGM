...
<div class="row">
    <div class="col-lg-12">
                <p>
                    ...
                    <a class="btn btn btn-danger" href="{{ route('generateItinerary', $package->packageID) }}" target="_blank">
...
<a href="{{ route('booking', [$tour->tourCode]) }}" class="btn btn-info">BOOK NOW</a>
</div>
</td>
</tr>
@endforeach
