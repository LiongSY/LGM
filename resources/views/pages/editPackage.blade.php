                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form onsubmit="return validateForm()"
                            action="{{ route('package.updatePackage', $package->packageID) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div> <a href="{{ URL::previous() }}" class="btn btn-secondary"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <input type="file" class="form-control-file" id="packageImage"
                                                name="packageImage" accept="image/*" onchange="displayImageName()">

                                            <label class="custom-file-label" for="packageImage">{{
                                                $package->packageImage }}</label>
                                            @error('packageImage')
