...
@section('content')
    <div class="content">
        ...
        <form class="col-md-12" action="{{ route('profile.update',auth()->user()->userID) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <input type="text" name="phoneNo" class="form-control" placeholder="Phone Number" value="{{ auth()->user()->phoneNo }}" required>
                    </div>
                ...
                <form class="col-md-12" action="{{ route('editPassword')}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-header">
