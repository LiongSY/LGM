...
<div class="content">
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-info" data-toggle="modal"
                                            data-target="#viewStaffModal{{ $customer->customerID }}">View</a>
                                        @if($customer->passportNo)
                                        <a href="#" class="btn btn-warning" data-toggle="modal"
                                            data-target="#viewPassportModal{{ $customer->passportNo }}">View
                                            Passport</a>
                                        @else
                                        <a href="#" class="btn btn-danger" data-toggle="modal"
                                            data-target="#addPassportModal{{ $customer->customerID }}">Add Passport</a>
                                        @endif
                                        @if($customer->benID)
                                        <a href="#" class="btn btn-secondary" data-toggle="modal"
                                            data-target="#viewBenModal{{ $customer->benID }}">View Beneficiary</a>
                                        @else
                                        <a href="#" class="btn btn-danger" data-toggle="modal"
                                            data-target="#addBenModal{{ $customer->customerID }}">Add Beneficiary</a>
                                        @endif
                                    </td>
                                </tr>
                                <div class="modal fade" id="viewStaffModal{{ $customer->customerID }}" tabindex="-1"
                                    role="dialog" aria-labelledby="viewStaffModalLabel{{ $customer->customerID }}"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"
                                                    id="viewStaffModalLabel{{ $customer->customerID }}">Customer Details
                                                </h5>
                                ...
                                <!-- view passport modal -->
                                <div class="modal fade" id="viewPassportModal{{ $customer->passportNo }}" tabindex="-1"
                                    role="dialog" aria-labelledby="viewPassportModalLabel{{ $customer->passportNo }}"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"
                                                    id="viewPassportModal{{ $customer->passportNo }}">Passport Details
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <b>Passport Image:</b>
                                                <br>
                                                <img src="{{ url('storage/images/'.$customer->passportImage) }}"
                                                    width='100%' height='300' />

                                            </div>
                                            <div class="modal-footer">
                                                <a href="{{ route('passport.edit', ['passportNo' => $customer->passportNo]) }}"
                                                    class="btn btn-warning">Edit Passport</a>
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">Close</button>
                                            </div>
                                        </div>
                                ...
                                <div class="modal fade" id="viewBenModal{{ $customer->benID }}" tabindex="-1"
                                    role="dialog" aria-labelledby="viewPassportModalLabel{{ $customer->benID }}"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="viewBenModal{{ $customer->benID }}">
                                            ...
                                            <div class="modal-footer">
                                                <a href="{{ route('beneficiary.edit', ['benID' => $customer->benID]) }}"
                                                    class="btn btn-warning">Edit Beneficiary</a>
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">Close</button>
                                            </div>
                                        </div>
                                ...
                                <div class="modal fade" id="addPassportModal{{ $customer->customerID }}" tabindex="-1"
                                    role="dialog" aria-labelledby="addPassportModalLabel{{ $customer->customerID }}"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"
                                                    id="addPassportModal{{ $customer->customerID }}">Add Passport
                                                    Details</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
        ...
        @enderror
                                ...
                                <div class="modal fade" id="addBenModal{{ $customer->customerID }}" tabindex="-1"
                                    role="dialog" aria-labelledby="addBenModalLabel{{ $customer->customerID }}"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"
                                                    id="addBenModalLabel{{ $customer->customerID }}">Add Beneficiary
                                                    Details</h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                            ...
                                            <div class="modal-body">
                                                <div id="benErrorMessages" class="alert alert-danger"
                                                    style="display: none;"></div>

                                                <form onsubmit="return validateBeneficiary()"
                                                    action="{{ route('beneficiary.store') }}" method="POST"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    <input type="hidden" name="customerID"
                                                        value="{{ $customer->customerID }}">
